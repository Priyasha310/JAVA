...
---
    ...
    For detailed coverage of Garbage Collection (examples, heap organization, algorithms, collectors, references), see [11.Garbage_Collection.md](11.Garbage_Collection.md).
