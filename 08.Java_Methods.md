...
Method Overriding is the process where a child class provides its own implementation of a method already defined in its parent class.

---

### Q2. Why is Method Overriding used?

To achieve **Runtime Polymorphism**, allowing different implementations of the same method based on the actual object.
...
> **Method Overriding = Same method signature in parent and child classes (Runtime Polymorphism).**
...
### Q2. What are the different types of methods?
...
### Q4. Can methods be overloaded only by changing the return type?
...
### Q6. What are the components of a method?
...
### Q8. What is the difference between `void` and a return type?
...
### Q9. What are the access modifiers in Java?
